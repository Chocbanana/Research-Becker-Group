...
Re-run the newloss on best model, on n128, with new ranks: 10, 15, 20, 25.
...
def run():
    ...
    for r in ranks_n128:
        ...
        m = ConvMF(r, mat_size_2, sl_n128, fl_n128, conv_dims).to(device)
        print(f"{m.get_name()} \trank = {r} \t sl={sl_n128} \t fl={fl_n128} \tcl={conv_dims}")
